...
public class PlayerController : Component
{
	...
	public Vector3 AimPosition => Eye.WorldPosition + (EyeAngles.ToRotation() * CameraOffset);
	...
	private void RotateCharacter()
	{
		...
		{
			Body.WorldRotation = Rotation.Lerp( Body.WorldRotation, targetAngle, Time.Delta * RotationSpeed );
		}
	}
